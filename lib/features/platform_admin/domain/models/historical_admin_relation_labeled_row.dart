class HistoricalAdminRelationLabeledRow {
  final int id;
  ...
  const HistoricalAdminRelationLabeledRow({
    required this.id,
    ...
    required this.sourcePeriodTitleAr,
    this.sourceOriginCommunityCode,
    required this.targetId,
    required this.targetCode,
    required this.targetPeriodId,
    required this.targetPeriodTitleAr,
  ...
  factory HistoricalAdminRelationLabeledRow.fromJson(
    ...
    return HistoricalAdminRelationLabeledRow(
